...
INSERT INTO cupom (cod_categoria, nome, descricao, pontos_necessarios, desconto) VALUES
(1, 'Desconto 5%', 'Cupom de 5% em qualquer produto.', 15, 5),
(1, 'Desconto 10%', 'Cupom de 10% em qualquer produto.', 30, 10);

INSERT INTO cupom (cod_categoria, nome, descricao, pontos_necessarios, desconto) VALUES
(2, 'Desconto 5%', 'Cupom de 5% em qualquer produto.', 12, 5),
(2, 'Desconto 10%', 'Cupom de 10% em qualquer produto.', 25, 10),
(2, 'Desconto 12%', 'Desconto especial para membros prata.', 35, 12);

INSERT INTO cupom (cod_categoria, nome, descricao, pontos_necessarios, desconto) VALUES
(3, 'Desconto 10%', 'Cupom de 10% em qualquer produto.', 20, 10),
(3, 'Desconto 15%', 'Melhor condição para ouro.', 35, 15),
(3, 'Desconto 18%', 'Cupom premium para categoria ouro.', 48, 18);

INSERT INTO cupom (cod_categoria, nome, descricao, pontos_necessarios, desconto) VALUES
(4, 'Desconto 12%', 'Desconto padrão da categoria.', 20, 12),
(4, 'Desconto 18%', 'Cupom especial para membros platina.', 36, 18),
(4, 'Desconto 20%', 'Desconto agressivo para compras maiores.', 45, 20);

INSERT INTO cupom (cod_categoria, nome, descricao, pontos_necessarios, desconto) VALUES
(5, 'Desconto 15%', 'Condição exclusiva para clientes fiéis.', 25, 15),
(5, 'Desconto 20%', 'Economize mais com seu status diamante.', 38, 20),
(5, 'Desconto 25%', 'Cupom VIP com desconto máximo.', 50, 25);

INSERT INTO cupom (cod_categoria, nome, descricao, pontos_necessarios, desconto) VALUES
(6, 'Desconto 20%', 'Desconto para clientes elite.', 30, 20),
(6, 'Desconto 25%', 'Condição especial para elite.', 45, 25),
(6, 'Desconto 30%', 'Máximo benefício para clientes mais leais.', 60, 30);
